<html>
  ...
  <body>
    <?php 
// MATERI 3
      $nama = "Tedy Iman"; /* ini adalah variabel          nama, ber value string */
      $umur = 21; // ini adalah variabel umur, ber value int
      $nilai = 90.90; // ini adalah variabel umur, ber value float/koma
      echo "<h2>Welcome</h2>"; 
